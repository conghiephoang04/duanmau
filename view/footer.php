    ...
    <div class="footer_area">
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                                                    <div class="modal_tab_img">
                                                        <a href="#"><img src="./view/assets/img/product/product13.jpg" alt=""></a>    
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="tab2" role="tabpanel">
                                                    <div class="modal_tab_img">
                                                        <a href="#"><img src="./view/assets/img/product/product14.jpg" alt=""></a>    
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="tab3" role="tabpanel">
                                                    <div class="modal_tab_img">
                                                        <a href="#"><img src="./view/assets/img/product/product15.jpg" alt=""></a>    
                                                    </div>
                                                </div>
                                            </div>
		...
		<!-- all js here -->
        <script src="./view/assets/js/vendor/jquery-1.12.0.min.js"></script>
        <script src="./view/assets/js/popper.js"></script>
        <script src="./view/assets/js/bootstrap.min.js"></script>
        <script src="./view/assets/js/ajax-mail.js"></script>
